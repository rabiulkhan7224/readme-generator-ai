                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pt-32 lg:pb-16 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <TextEffect
                                ...
                                Instantly generate professional README files for your projects using AI. 
                                Just tell us a few details, and we will handle the rest!
                            </TextEffect>
